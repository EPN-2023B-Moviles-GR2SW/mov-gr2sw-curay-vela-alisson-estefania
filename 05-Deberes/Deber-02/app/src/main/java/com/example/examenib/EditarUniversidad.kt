...
class EditarUniversidad : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val idUniversidad = intent.getLongExtra("idUniversidad", -1)
        ...
        botonAceptar.setOnClickListener {
            ...
            if (nombreModificado != null && ubicacionModificada != null
                ...
                val universidadModificada = Universidad(
                    idUniversidad,
                    nombreModificado,
                    ubicacionModificada,
                ...
                // Actualizar la universidad en la base de datos
                universidadDBHandler.actualizarUniversidad(universidadModificada)
