    ...
    fun EliminacionDialogo() { // diálogo para confirmación de eliminación
        ...
        builder.setPositiveButton(
            ...
            DialogInterface.OnClickListener { dialog, which ->
                ...
                val estudianteSeleccionado = MainActivity.array[MainActivity.posicionElementoSeleccionado]
                    .listaEstudiantes[posicionElementoEstudiantes]

                // Llama al método eliminarEstudiante en el EstudianteDBHandler
                estudianteDBHandler.eliminarEstudiante(estudianteSeleccionado.id)

                // Elimina el estudiante de la lista local
                MainActivity.array[MainActivity.posicionElementoSeleccionado]
